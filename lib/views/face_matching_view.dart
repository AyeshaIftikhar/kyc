...
class FaceMatchingScreen extends StatefulWidget {
  const FaceMatchingScreen({super.key, required this.image});
  final String image;
  @override
  State<FaceMatchingScreen> createState() => _FaceMatchingScreenState();
}

class _FaceMatchingScreenState extends State<FaceMatchingScreen> {
  var image1 = Regula.MatchFacesImage();
  var image2 = Regula.MatchFacesImage();
  String image = '';
  var img1 = Image.asset(''), img2 = Image.asset('');
  ...
  Future<void> initPlatformState() async {
    ...
    setImage(
      true,
      io.File(widget.image).readAsBytesSync(),
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        body: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              createImage(
                Image.file(io.File(widget.image)).image,
